...
/// This means that each node contains an entire array of elements, instead of just a single element.
///
...
/// are notably expensive in practice, we are forced to, at the very least,
